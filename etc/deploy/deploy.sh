...
scp -o ProxyCommand="ssh -W %h:%p deploy@estadisticas.arte-consultores.com" metamac-registry-web/target/sdmx-registry-*.war deploy@192.168.10.16:$TRANSFER_PATH/sdmx-registry.war
